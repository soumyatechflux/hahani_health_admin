...
import EmployeesData from "./Employees"; // Renamed to EmployeesData to avoid confusion
...
const Vender = () => {
  ...
  const [newData, setNewData] = useState({ Sr: "", name: "", location: "", createdAt: "" });
    ...
    <Fragment>
      <div className="container container-vender " style={{marginTop:'2.6%'}}>
        <div className="d-flex align-items-center justify-content-between top-margin-heading">
          <h1 className="text-class ">Vender Details </h1>

          {/* Add button is   */}
          <div className="btn-class" >
            <Button size="lg" className="add-btn" onClick={handleCreate}>Add Vender</Button>
          </div>
        </div>
        <Table responsive striped bordered hover size="sm" className="table-resp">
          <thead>
            <tr>
              ...
              <th className="col-3 col-md-3">Vender Name</th>
              ...
              ? employees.map((item) => (
                <tr key={item.id}>
                  ...
                  <td className="action-users">
                    {/* <Button size="sm" variant="success" onClick={() => handleEdit(item.id, item.Name, item.location, item.createdAt)}>
                        Edit
                      </Button>
        ...
        {/* <div className="d-grid gap-2" style={{ display: "flex", justifyContent: "center", alignItems: "center" }}>
          <Button size="lg" onClick={handleCreate}>Add Vender</Button>
        </div> */}
      </div>
